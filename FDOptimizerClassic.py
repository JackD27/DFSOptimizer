...
data_file = 'myOwnDataNFLClassicFD.csv'
...
'''
removeNames = ['Jayson Tatum', 'Stephen Curry']         #add names in the brackets, if you want a certain player or not.
...
print("Projected points for the game: ", lineups['PPG'].sum())
